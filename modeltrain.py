...
face_classifier = cv2.CascadeClassifier('/root/Desktop/jupyter/haarcascade_frontalface_default.xml')
...
while True:
    ...
    try:
        ...
        if confidence > 85:
            ...
            sp.getoutput("usermod -U harry")
                       
        else:
            cv2.putText(image, "i dont recognize you ", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
            cv2.imshow('Face Recognition', image )
